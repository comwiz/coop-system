...
$referencenumber = "J" . $referencenumberTemp;
        ...
        if($countErr<=0){
            ...
            if(substr("$blLA",0,2) == "BL" and $blPayment != 0){
                ...
                $sql = "INSERT INTO bl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$referencenumber','$blLA','$blPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO bl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$blLA', '$voucherNumber' , '$checqueNumber' , '$referencenumber','$blPaymentI','$datePayment', '$encodedBy')";
            ...
            if(substr("$cmlLA",0,3) == "CML" and $emlPayment != 0){
                ...
                $sql = "INSERT INTO cml_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$referencenumber','$cmlLA','$cmlPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO cml_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$cmlLA', '$voucherNumber' , '$checqueNumber' , '$referencenumber','$cmlPaymentI','$datePayment', '$encodedBy')";
            ...
            if(substr("$edlLA",0,3) == "EDL" and $edlPayment != 0){
                ...
                $sql = "INSERT INTO edl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$referencenumber','$edlLA','$edlPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO edl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$edlLA', '$voucherNumber' , '$checqueNumber' , '$referencenumber','$edlPaymentI','$datePayment', '$encodedBy')";
            ...
            if(substr("$rlLA",0,2) == "RL" and $rlPayment != 0){
                ...
                $sql = "INSERT INTO rl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$referencenumber','$rlLA','$rlPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO rl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$rlLA', '$voucherNumber' , '$checqueNumber' , '$referencenumber','$rlPaymentI','$datePayment', '$encodedBy')";
            ...
            if(substr("$plLA",0,2) == "PL" and $plPayment != 0){
                ...
                $sql = "INSERT INTO pl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$loanApplicationNumberA','$plLA','$plPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO pl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$plLA', '$voucherNumber' , '$checqueNumber' , '$loanApplicationNumberA','$pliPayment','$datePayment', '$encodedBy')";
            ...
            if($bbfPayment != 0){
                ...
                $sqlJE = "INSERT INTO journal_report_table(id_number, account_code, account_code_lc, cr_dr,journal_number, journal_number_temp, amount, remarks, date_transaction, encoded_by) 
                VALUES ('$idNumber','23121', 'MB', 'DR','$referencenumber', $referencenumberTemp ,'$bbfPayment', 'Offset CBU' ,'$datePayment','encodedBy')";
